/**
 * Bounty detail page component.
 * @module components/bounty/BountyDetail
 */
...
/**
 * Full bounty detail page with sidebar and submission form.
 * Shows complete bounty information, reward, deadline, and submission options.
 */

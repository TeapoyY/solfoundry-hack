          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="bg-forge-800 border border-border rounded-lg pl-9 pr-8 py-1.5 text-sm text-text-primary placeholder-text-muted focus:border-emerald outline-none transition-colors duration-150 w-48 focus:w-64"
                style={{ transition: 'width 0.2s ease, border-color 0.15s ease' }}
              />
              {searchInput && (
                <button

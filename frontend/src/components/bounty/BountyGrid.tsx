...
export function BountyGrid() {
  ...
  const filteredBounties = debouncedQuery
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full sm:w-56 appearance-none bg-forge-800 border border-border rounded-lg pl-9 pr-8 py-1.5 text-sm text-text-secondary placeholder-text-muted focus:border-emerald outline-none transition-colors duration-150"
              />
              {searchQuery && (
                <button

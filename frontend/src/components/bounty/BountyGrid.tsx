/**
 * Bounty grid component with filtering and search.
 * @module components/bounty/BountyGrid
 */
...
/** Available skill filter options */
const FILTER_SKILLS = ['All', 'TypeScript', 'Rust', 'Solidity', 'Python', 'Go', 'JavaScript'];

/**
 * Bounty grid with client-side search and language/status filtering.
 * Displays bounties in a responsive 3-column grid with infinite scroll.
 */

...
export function BountyGrid() {
  ...
  // Filter by search query (title, description, and skills)
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="bg-forge-800 border border-border rounded-lg pl-8 pr-8 py-1.5 text-sm text-text-primary placeholder:text-text-muted focus:border-emerald outline-none transition-colors duration-150 w-44 focus:w-56"
              />
              {searchInput && (
                <button
